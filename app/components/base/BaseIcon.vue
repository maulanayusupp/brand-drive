...
const ICONS: Record<string, string> = {
  ...
  rocket: '<path d="M12 3c3 1.6 4.5 4.6 4.5 8.5L14 15h-4l-2.5-3.5C7.5 7.6 9 4.6 12 3z"/><circle cx="12" cy="9" r="1.3"/><path d="M9.5 15c-1.5.5-2.5 2-2.5 4 1.5 0 3-.7 3.5-2M14.5 15c1.5.5 2.5 2 2.5 4-1.5 0-3-.7-3.5-2"/>',
